...
| `autoApplyRunTrigger` _boolean_ | Configures this workspace to automatically apply changes for successful runs.<br />More information:<br />  - https://developer.hashicorp.com/terraform/cloud-docs/workspaces/settings/run-triggers#run-triggers-auto-apply-setting |
