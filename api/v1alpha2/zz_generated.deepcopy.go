...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RunPlanOnlyStatus) DeepCopyInto(out *RunPlanOnlyStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RunPlanOnlyStatus.
func (in *RunPlanOnlyStatus) DeepCopy() *RunPlanOnlyStatus {
	if in == nil {
		return nil
	}
	out := new(RunPlanOnlyStatus)
	in.DeepCopyInto(out)
	return out
}
