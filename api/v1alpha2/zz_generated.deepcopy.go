...
func (in *AgentPoolSpec) DeepCopyInto(out *AgentPoolSpec) {
	*out = *in
	...
	if in.AgentPoolTokens != nil {
		in, out := &in.AgentPoolTokens, &out.AgentPoolTokens
		*out = make([]*AgentPoolToken, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(AgentPoolToken)
				(*in).DeepCopyInto(*out)
			}
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AgentPoolToken) DeepCopyInto(out *AgentPoolToken) {
	*out = *in
	if in.CreatedAt != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AgentPoolToken.
func (in *AgentPoolToken) DeepCopy() *AgentPoolToken {
	if in == nil {
		return nil
	}
	out := new(AgentPoolToken)
